...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        //final method is always equals in every class
        naruto.welcome();
        naruto.shouting();

        //final atributes can't be changed
        System.out.println(naruto.PI);
        //int PI = 314  it will not work because PI is final
